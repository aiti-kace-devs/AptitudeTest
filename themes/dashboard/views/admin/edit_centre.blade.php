                  ...
                  <div class="row">
                    <div class="col-sm-12">
                      <div class="form-group">
                        ...
                        <select name="branch_id" class="form-control" id="branch_id">
                          ...
                          <option value="{{ $branch->id }}" @if($centre->branch->id === $branch->id) selected @endif>{{ $branch->title }}</option>
                          @endforeach
                        </select>
                    ...
                    <div class="col-sm-12">
                      <div class="form-group">
                        ...
                        <input type="text" value="{{ $centre->title }}" name="title" placeholder="Enter centre title" class="form-control" id="title">
