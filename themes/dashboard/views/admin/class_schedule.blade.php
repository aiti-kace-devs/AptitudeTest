                ...
                <table class="table table-striped table-bordered table-hover datatable">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="d-flex">
                        <a href="{{ route('admin.course.edit', $schedule->id) }}" class="btn btn-info">Edit</a>
                        <a href="{{ route('admin.course.destroy', $schedule->id) }}" class="btn btn-danger ml-2">Delete</a>
                      </td>
                    </tr>
                    @endforeach
                  </tbody>
            ...
            <div class="row">
              <div class="col-sm-12">
                <div class="form-group">
                  ...
                  <span class="course_id_error font-weight-bold invalid-feedback" style="display: block;" role="alert"></span>
                </div>
              </div>
              ...
              <div class="col-sm-12">
                <div class="form-group">
                  ...
                  <span class="session_id_error font-weight-bold invalid-feedback" style="display: block;" role="alert"></span>
                </div>
              </div>
              <div class="col-sm-12">
                <div class="form-group">
