            ...
            <div class="course-grid">
                <div class="course-card">
                    ...
                    <div class="course-content">
                        ...
                        <a href="{{ route('dynamic-course', ['course' => 'cybersecurity-course']) }}"
                ...
                <div class="course-card">
                    ...
                    <div class="course-content">
                        ...
                        <a href="{{ route('dynamic-course', ['course' => 'data-protection-course']) }}"
                            class="course-button">Read More</a>
                    </div>
                </div>
                ...
                <div class="course-card">
                    ...
                    <div class="course-content">
                        ...
                        <a href="{{ route('dynamic-course', ['course' => 'protection-expert-course']) }}"
                            class="course-button">Read More</a>
                    </div>
                </div>
                ...
                <div class="course-card">
                    ...
                    <div class="course-content">
                        ...
                        <p class="course-description">
                            This course offers comprehensive, hands-on training in artificial intelligence fundamentals,
                            including machine learning, neural networks, and deep learning. Designed for both beginners
                        ...
                        <a href="{{ route('dynamic-course', ['course' => 'ai-course']) }}" class="course-button">Read
                            More</a>
                    </div>
                </div>
                <div class="course-card">
                    ...
                    <div class="course-content">
                        ...
                        <a href="{{ route('dynamic-course', ['course' => 'protection-sup-course']) }}"
                            class="course-button">Read More</a>
                    </div>
                </div>
                ...
                <div class="course-card">
                    ...
                    <div class="course-content">
                        ...
                        <p class="course-description">
                            Monitor compliance with data protection laws and policies, detect and assess data
            ...
            <div class="course-grid">
                ...
                <div class="course-card">
                    ...
                    <div class="course-content">
                        ...
                        <a href="{{ route('dynamic-course', ['course' => 'cnst-course']) }}"
                            class="course-button">Read More</a>
                    </div>
                </div>
            </div>
