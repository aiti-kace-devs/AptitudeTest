            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <div class="p-6">
                    <div>
                        ...
                        <p
                            v-if="admissionForm.description"
                        ...
                        <form @submit.prevent="submit">
                            <div class="space-y-5">
                                <div
                                    v-for="(
                                        question, index
                                    ) in admissionForm.schema"
                                    :key="index"
                                >
                                    <div>
                                        <InputLabel
                                            v-if="
                                                question.type != 'select_course'
                                            "
                                            :for="`field-${index}`"
                                        ...
                                        <TextInput
                                            ...
                                            :class="{
                                                ...
                                                'border-red-600':
                                                    form.errors[
                                                        `response_data.${question.field_name}`
                                                    ],
                                            }"
                                        />
                                        ...
                                        >
                                            <phone-input
                                                class="[&_.baseinput-core]:p-0 [&_.cursor-pointer]:pl-2 [&_input]:pl-2"
