...
return new class extends Migration {
    ...
    public function up()
    {
        ...
        SELECT ua.user_id AS user_id, u.name AS user_name, u.gender AS user_gender, u.network_type AS user_network_type, u.mobile_no AS user_contact, s.id AS course_id, s.location AS course_location, s.course_name AS course_name, at.attendance_date, at.total
